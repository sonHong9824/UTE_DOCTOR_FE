import { BellRing, FileText, Heart, Lock, User } from "lucide-react";
...
export default function Sidebar({ activeTab, setActiveTab }: SidebarProps) {
  const tabs = [
    ...
    { id: "notifications", label: "Thông báo", icon: <BellRing size={20} /> },
    { id: "wallet", label: "Ví Điện Tử", icon: <FileText size={20} /> },
  ];
