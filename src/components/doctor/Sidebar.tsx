"use client";
import { LayoutDashboard, Users, Calendar, FileText, Stethoscope, MessageSquare, Settings, User, LogOut, ChevronRight, Activity, ClipboardList } from "lucide-react";
...
const menuItems = [
  ...
  { 
    ...
    badge: { count: 5, color: "bg-amber-500" }
  },
  { 
    name: "Hồ sơ y tế", 
    icon: ClipboardList, 
  ...
  { 
    ...
    badge: { count: 2, color: "bg-rose-500" }
  },
  { 
    name: "Cài đặt", 
    icon: Settings, 
          ...
          <>
            <div className="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/30 dark:to-indigo-900/30">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold text-gray-900 dark:text-white truncate">Dr. Nguyễn Văn Minh</p>
                <p className="text-xs text-gray-500 dark:text-gray-400">Bác sĩ tim mạch</p>
              </div>
            </div>
